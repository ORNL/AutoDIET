...
#html_title = u'pyNSID ' + ad_version
...
latex_documents = [
    (master_doc, 'AutoDIET.tex', 'AutoDIET Documentation',
     'Suhas Somnath', 'manual'),
]
...
man_pages = [
    (master_doc, 'autodiet', 'AutoDIET Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AutoDIET', 'AutoDIET Documentation',
     author, 'AutoDIET', 'Tools that assist in automated ingestion of data into DataFed',
     'Miscellaneous'),
]
